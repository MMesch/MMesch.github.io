...
(function ($PS) {
  ...
  var listCard = function listCard(post) {
    ...
    return Halogen_HTML_Elements.a(Data_Semigroup.append(Data_Semigroup.semigroupArray)([Halogen_HTML_Properties.href(href), cn("hover:cursor-pointer w-full block p-4 md:p-6 my-3 border-solid border-2 rounded-lg")])(function () {
      ...
      ;
      throw new Error("Failed pattern match at Pages (line 173, column 14 - line 175, column 50): " + [post.external.constructor.name]);
  ...
  var loadingPage = layout1([Halogen_HTML_Core.text("Loading")]);
  ...
  var mainPage = function mainPage(maybeCV) {
    ...
    return layout1(function () {
      ...
      ;
      throw new Error("Failed pattern match at Pages (line 38, column 7 - line 55, column 12): " + [maybeCV.constructor.name]);
    }());
  };
  ...
  var blogPage = function blogPage(post) {
    ...
    return layout1([Halogen_HTML_Elements.div([cn("markdown max-w-2xl border-t-2 lg:border-0 border-gray px-3 mx-auto py-16")])([Halogen_HTML_Elements.div([cn("text-gray-800 text-lg")])([Halogen_HTML_Core.text(date)]), Halogen_HTML_Elements.h1([])([Halogen_HTML_Core.text(title)]), function () {
      ...
      ;
      throw new Error("Failed pattern match at Pages (line 80, column 13 - line 82, column 83): " + [post.description.constructor.name]);
    }(), rendered])]);
  };
...
(function ($PS) {
  ...
  var stripSlash = function stripSlash(str) {
    return Data_Maybe.fromMaybe(str)(Data_String_CodeUnits.stripSuffix("/")(str));
  };
  ...
  var pageCodec = Routing_Duplex_Generic.sum(Types.genericPage)(Routing_Duplex_Generic.gRouteSum(Routing_Duplex_Generic.gRouteConstructor(new Data_Symbol.IsSymbol(function () {
    ...
    Loading: Routing_Duplex_Generic_Syntax.gsep(Routing_Duplex_Generic_Syntax.gsepStringRoute(Routing_Duplex_Generic.gRouteNoArguments))("loading")(Routing_Duplex_Generic.noArgs),
  ...
  var validateUrl = function validateUrl(dictMonadEffect) {
    return function (nav) {
      return Control_Bind.bind(dictMonadEffect.Monad0().Bind1())(Effect_Class.liftEffect(dictMonadEffect)(nav.locationState))(function (v) {
        var initialRoute = Data_Either.hush(Routing_Duplex.parse(routeCodec)(stripSlash(v.path)));
...
(function ($PS) {
  ...
  var pageTitle = function pageTitle(posts) {
    return function (page) {
      if (page instanceof Types.Main) {
        return "Welcome";
      }

      ;

      if (page instanceof Types.BlogList) {
        return "Blog List";
      }

      ;

      if (page instanceof Types.Blog) {
        return Data_Maybe.fromMaybe("")(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(page.value0)(posts))(function (post) {
          return post.title;
        }));
      }

      ;
      throw new Error("Failed pattern match at Main (line 101, column 24 - line 106, column 32): " + [page.constructor.name]);
    };
  };

  var setTitle = function setTitle(posts) {
    return function (route) {
      var title = Data_Maybe.fromMaybe("not found")(Control_Bind.bind(Data_Maybe.bindMaybe)(route)(function (page) {
        return Control_Applicative.pure(Data_Maybe.applicativeMaybe)(pageTitle(posts)(page));
      }));
      return Control_Bind.bind(Effect.bindEffect)(Control_Bind.bind(Effect.bindEffect)(Web_HTML.window)(Web_HTML_Window.document))(Web_HTML_HTMLDocument.setTitle(title));
    };
  };
  ...
  var navigateHalogenM = function navigateHalogenM(dictNavigate) {
    return new Navigate(function () {
      ...
      return Control_Monad_Trans_Class.lift(Halogen_Query_HalogenM.monadTransHalogenM)(dictNavigate.Monad0())(navigate(dictNavigate)(route));
    });
  };
  ...
  var navigateAppMPush = new Navigate(function () {
    ...
    return Control_Bind.bind(bindAppM)(Control_Monad_Reader_Class.asks(monadAskAppM(Type_Equality.refl))(function (v) {
      ...
      return Routes.setUrl(monadEffectAppM)(nav)(route);
    });
  });

  var component = function () {
    var render = function render(state) {
      if (state.page instanceof Data_Maybe.Nothing) {
        return Pages.loadingPage;
      }

      ;

      if (state.page instanceof Data_Maybe.Just) {
        if (state.page.value0 instanceof Types.Main) {
          return Pages.mainPage(state.cv);
        }

        ;

        if (state.page.value0 instanceof Types.BlogList) {
          return Pages.blogList(state);
        }

        ;

        if (state.page.value0 instanceof Types.Blog) {
          return Data_Maybe.fromMaybe(Pages.mainPage(state.cv))(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Map_Internal.lookup(Data_Ord.ordString)(state.page.value0.value0)(state.posts))(function (post) {
    ...
    var handleQuery = function handleQuery(v) {
      return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
        return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Applicative.when(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Eq.notEq(Data_Maybe.eqMaybe(Types.eqPage))(state.page)(v.value0))(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (s) {
          ...
          return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(monadEffectAppM))(setTitle(state.posts)(v.value0)))(function () {
            ...
            return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Routes.validateUrl(Halogen_Query_HalogenM.monadEffectHalogenM(monadEffectAppM))(nav))(function () {
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(monadAffAppM))(Util.fetchYaml(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
                ...
                return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(monadAffAppM))(Util.fetchList("/posts/posts.dat")))(function (postListEither) {
                    ...
                    if (postListEither instanceof Data_Either.Right) {
                      var paths = Data_Functor.map(Data_Functor.functorArray)(Data_Semigroup.append(Data_Semigroup.semigroupString)("/posts/"))(postListEither.value0);

...
(function ($PS) {
  ...
  var genericPage = new Data_Generic_Rep.Generic(function (x) {
    ...
    ;
    throw new Error("Failed pattern match at Types (line 20, column 1 - line 20, column 46): " + [x.constructor.name]);
  }, function (x) {
    ...
    if (x instanceof Data_Generic_Rep.Inr && x.value0 instanceof Data_Generic_Rep.Inr && x.value0.value0 instanceof Data_Generic_Rep.Inr) {
      return new Blog(x.value0.value0.value0);
    }
...
(function ($PS) {
  ...
  var Web_UIEvent_MouseEvent = $PS["Web.UIEvent.MouseEvent"]; // This is a little helper to save some space
...
(function ($PS) {
  ...
  var component = function () {
    var render = function render(state) {
      if (state.page instanceof Types.Loading) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 166, column 18 - line 174, column 33): " + [state.page.constructor.name]);
    };

    var initialState = function initialState(v) {
      return {
        page: Types.Loading.value,

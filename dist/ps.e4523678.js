...
(function (exports) {
  exports.decodeHtmlEntity = function (input) {
    ...
    var doc = new DOMParser().parseFromString(input.slice(space.length), "text/html");
...
(function ($PS) {
  ...
  var optional = function optional(p) {
  ...
  var sepEndBy1 = function sepEndBy1(p) {
    return function (sep) {
  ...
  var sepEndBy = function sepEndBy(p) {
    return function (sep) {
...
(function ($PS) {
  ...
  var regex = function regex(pat) {
    ...
    var matchRegex = function matchRegex(r) {
      return function (v) {
...
(function ($PS) {
  ...
  var mkElement = function mkElement(v) {
    return function (v1) {
      return function (v2) {
        return {
          name: v,
  ...
  var isSelfClosingElement = function isSelfClosingElement(ele) {
...
(function ($PS) {
  ...
  var Web_HTML_Common = $PS["Web.HTML.Common"]; // This is a little helper to save some space
  ...
  */
  ...
  var mainPage = function mainPage(maybeCV) {
    ...
    return layout1(function () {
      ...
      ;
      throw new Error("Failed pattern match at Pages (line 33, column 7 - line 50, column 12): " + [maybeCV.constructor.name]);
    }());
  };
  ...
  var blogPage = function blogPage(post) {
    ...
    return layout1([Halogen_HTML_Elements.div([cn("markdown max-w-4xl border-t-2 lg:border-0 border-gray px-3 mx-auto py-16")])([Halogen_HTML_Elements.div([cn("text-gray-800 text-lg")])([Halogen_HTML_Core.text(date)]), Halogen_HTML_Elements.h1([])([Halogen_HTML_Core.text(title)]), function () {
      ...
      ;
      throw new Error("Failed pattern match at Pages (line 75, column 13 - line 77, column 83): " + [post.description.constructor.name]);
    }(), rendered])]);
  }; // pages
...
(function ($PS) {
  ...
  var genericPage = new Data_Generic_Rep.Generic(function (x) {
    ...
    ;
    throw new Error("Failed pattern match at Types (line 18, column 1 - line 18, column 46): " + [x.constructor.name]);
  }, function (x) {
...
(function ($PS) {
  ...
  var listenForUrlHashChanges = function listenForUrlHashChanges(halogenIO) {
    return Routing_Hash.matchesWith(Data_Foldable.foldableEither)(function () {
      var $11 = Routing_Duplex.parse(routeCodec);
      return function ($12) {
        return $11(stripBang($12));
      };
    }())(function (old) {
      return function ($$new) {
  ...
  var setUrlHash = function setUrlHash(dictMonadEffect) {
    var $13 = Effect_Class.liftEffect(dictMonadEffect);
    return function ($14) {
      return $13(Routing_Hash.setHash(addBang($14)));
    };
  };
...
(function ($PS) {
  ...
  var navigateAppMHash = new Navigate(function () {
    return monadAppM;
  }, function (route) {
    return Routes.setUrlHash(monadEffectAppM)(Routing_Duplex.print(Routes.routeCodec)(route));
  });
  ...
  var component = function () {
    var render = function render(state) {
      ...
      ;
      throw new Error("Failed pattern match at Main (line 165, column 18 - line 172, column 33): " + [state.page.constructor.name]);
    };
      ...
      return function (v) {
        if (v instanceof Types.SwitchPage) {
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (state) {
            return navigate(navigateHalogenM(navigateAppMHash))(new Data_Maybe.Just(v.value0));
          });
        }
          ...
          return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(monadAffAppM))(Util.fetchYaml(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeRecord(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonCons(Data_Argonaut_Decode_Class.decodeFieldId(Data_Argonaut_Decode_Class.decodeJsonString))(Data_Argonaut_Decode_Class.gDecodeJsonNil)(new Data_Symbol.IsSymbol(function () {
            ...
            return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (state) {
              ...
              return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(monadAffAppM))(Util.fetchList("/blog/posts.dat")))(function (postListEither) {
                ...
                ;
                throw new Error("Failed pattern match at Main (line 147, column 7 - line 160, column 60): " + [postListEither.constructor.name]);
              });
            });
          });
        }
        ...
        ;
        throw new Error("Failed pattern match at Main (line 139, column 18 - line 160, column 60): " + [v.constructor.name]);
      };
    }();
  ...
  exports["navigateAppMHash"] = navigateAppMHash;
})(PS);
